...
from jovialengine import engineconstants
...
WINDOW_ICON = os.path.join(engineconstants.GRAPHICS_DIRECTORY, 'icon.png')
FONT = os.path.join(engineconstants.GRAPHICS_DIRECTORY, 'simple_mono.ttf')

LOGOS_DIRECTORY = os.path.join(engineconstants.GRAPHICS_DIRECTORY, 'logos')
...
BACKGROUNDS_DIRECTORY = os.path.join(engineconstants.GRAPHICS_DIRECTORY, 'backgrounds')
...
MONSTER_PARTS_DIRECTORY = os.path.join(engineconstants.GRAPHICS_DIRECTORY, 'monster-parts')

THUNK = os.path.join(engineconstants.SOUND_DIRECTORY, 'thunk.ogg')
SPROING = os.path.join(engineconstants.SOUND_DIRECTORY, 'sproing.ogg')
FSSSH = os.path.join(engineconstants.SOUND_DIRECTORY, 'fsssh.ogg')
BIP = os.path.join(engineconstants.SOUND_DIRECTORY, 'bip.ogg')
LONGSLIDE = os.path.join(engineconstants.SOUND_DIRECTORY, 'longslide.ogg')
ROOEEE = os.path.join(engineconstants.SOUND_DIRECTORY, 'rooeee.ogg')
BWOP = os.path.join(engineconstants.SOUND_DIRECTORY, 'bwop.ogg')

MUSIC_DIRECTORY = os.path.join(engineconstants.SOUND_DIRECTORY, 'music')
