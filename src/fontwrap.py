...
class FontWrap(object):
    ...
    def renderTo(self, surf: pygame.Surface, dest, text: str, antialias: bool, color, background=None):
        surf.blit(self._font.render(text, antialias, color, background), dest)

    def renderToCentered(self, surf: pygame.Surface, dest, text: str, antialias, color, background=None):
    ...
    def renderWordsInside(self, width: int, words: list[str], antialias: bool, color, background=None):
    ...
    def renderToInside(self, surf: pygame.Surface, dest, width: int, text: str, antialias: bool, color, background=None):
    ...
    def renderInside(self, width: int, text: str, antialias: bool, color, background=None):
