# Originally copied in from http://www.pygame.org/wiki/2DVectorClass
# As per http://pygame.org/wiki/CookBook :
# "Except where otherwise noted, recipes posted in the pygame cookbook are in public domain."
# This has been altered since then, but this file shall remain in the public domain.
...
class Vec2d(object):
    ...
    def get_length(self):
        return math.sqrt(self.get_length_sqrd())
